...
export default class VisaPage_1 extends React.Component {
  constructor() {
    super();
    this.state = {
      inputVal_1: "",
      ...
      <>
        ...
        >
          ...
          >
            ...
            >
              <Text style={{ fontSize: 17, color: "#26508E" }}>
                Add Card Details
              </Text>
            </View>
            ...
            <TextInput
              ...
              onChangeText={(value) => {
                this.setState({ inputVal_3: value });
              }}
            />
            <View
              style={{
            ...
            >
              <TextInput
                ...
                onChangeText={(value) => {
                  this.setState({ inputVal_4: value });
                }}
              />
              <TextInput
                style={{
                ...
                onChangeText={(value) => {
                  this.setState({ inputVal_5: value });
                }}
              />
            </View>
            <View
            ...
            >
              ...
              >
                {this.state.data ? (
                  <Icon name="check-square" size={15} color="gray" />
                ) : (
                  <Icon name="square" size={15} color="gray" />
                )}
              </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                this.props.navigation.navigate('VisaPage_2');
              }}
            >
              <Text style={{ fontSize: 15, color: "#fff" }}>Add Card</Text>
            </TouchableOpacity>
          </View>
        </View>
      </>
